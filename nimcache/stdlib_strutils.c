...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.18.0_1/nim/lib -o /Users/faysalahmed/Documents/projects/nim_projects/hello_nim/nimcache/stdlib_strutils.o /Users/faysalahmed/Documents/projects/nim_projects/hello_nim/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_25, "invalid enum value: ", 20);
...
appendString(T9_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_25));
appendString(T9_, s);
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(230, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_27 = subInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_27), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_26 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(2048, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_28 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_28);
			} LA3: ;
		}
	}
	popFrame();
